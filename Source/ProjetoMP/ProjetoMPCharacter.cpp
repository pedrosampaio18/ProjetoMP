...
AProjetoMPCharacter::AProjetoMPCharacter()
{
...
void AProjetoMPCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AProjetoMPCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AProjetoMPCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AProjetoMPCharacter::OnResetVR);
}
...
void AProjetoMPCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AProjetoMPCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
